<?php $__env->startSection('title', translate('Diagnosis & Tests')); ?>
...
<section class="app-user-list">
  <div class="card">
    <div class="card-body border-bottom">
        <h4 class="card-title"><?php echo e(translate('Diagnosis & Tests')); ?></h4>
            <div class="dt-action-buttons text-xl-end text-lg-start text-lg-end text-start "><div class="dt-buttons"><a class="dt-button btn btn-primary btn-add-record ms-2" tabindex="0" aria-controls="DataTables_Table_0" href="<?php echo e(route('test.add')); ?>"><span><?php echo e(translate('Add Diagnosis & Tests')); ?></span></a> </div>
        </div>
    </div>
        ...
        <table class="user-list-table table">
            <thead class="table-light">
                <tr>
                    ...
                    <th><?php echo e(translate('Center')); ?></th>
...
<?php $__env->startSection('custom-js'); ?>
 ...
 <!-- BEGIN: Page Vendor JS-->
    ...
    var table = $('.user-list-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "<?php echo e(route('test.list')); ?>",
        columns: [
            {data: 'id', name: 'id'},
            {data: 'name', name: 'name'},
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pharmacyapp\resources\views/test/list.blade.php ENDPATH**/ ?>