...
<?php $__env->startSection('custom-js'); ?>
 <!-- BEGIN: Page Vendor JS-->
    ...
    var table = $('.user-list-table').DataTable({
        ...
        <?php else: ?>
        ajax: "<?php echo e(route('purchase.return.history')); ?>",
    <?php endif; ?>
        columns: [
            {data: 'id', name: 'id'},
            {data: 'date', name: 'date'},
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pharmacyapp\resources\views/purchase/returns.blade.php ENDPATH**/ ?>