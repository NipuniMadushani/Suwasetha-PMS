<?php $__env->startSection('title', __('pages.add_method')); ?>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title"><?php echo e(__('pages.add_method')); ?></h4>
                </div>
                <div class="card-body">
                  <form class="form" method="POST">
                    ...
                    <div class="row">
                     ...
                     <div class="col-md-6 col-12">
                        <div class="mb-1">
                          <label class="form-label" for="first-name-column"><?php echo e(__('pages.balance')); ?></label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pharmacyapp\resources\views/method/add.blade.php ENDPATH**/ ?>