    ...
    <section class="app-user-list">
        <div class="card">
            <div class="card-body border-bottom">
                <h4 class="card-title"><?php echo e(__('pages.customer_list')); ?></h4>
                <div class="row">
                ...
                <table class="user-list-table table">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th><?php echo e(__('pages.due')); ?> <?php echo e(Auth::user()->shop->currency); ?></th>
...
<?php $__env->startSection('custom-js'); ?>
 ...
 <!-- BEGIN: Page Vendor JS-->
    ...
    var table = $('.user-list-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "<?php echo e(route('customer.list')); ?>",
        columns: [
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pharmacyapp\resources\views/customer/list.blade.php ENDPATH**/ ?>