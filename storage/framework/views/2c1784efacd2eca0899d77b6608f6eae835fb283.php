<?php $__env->startSection('title', __('pages.edit_supplier')); ?>
          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <form class="form" method="POST" action="<?php echo e(route('supplier.edit', $customer->id)); ?>">
                      <?php echo csrf_field(); ?>
                    <div class="row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pharmacyapp\resources\views/supplier/edit.blade.php ENDPATH**/ ?>