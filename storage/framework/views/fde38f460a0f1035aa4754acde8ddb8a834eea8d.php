            ...
            <table class="user-list-table table table-bordered border-dark">
                <thead class="table-light">
                    <tr>
                        ...
                        <th><?php echo e(translate('Expired on')); ?></th>
                        <th><?php echo e(translate('Supplier')); ?></th>
                        <th><?php echo e(translate('Delete')); ?></th>
                    </tr>
                </thead>
            </table>
        </div>        
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pharmacyapp\resources\views/medicine/expired.blade.php ENDPATH**/ ?>