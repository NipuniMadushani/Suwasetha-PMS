...
<div class="modal-body">
    <div class="">
        ...
        <div class="details pvl43">
            <a href="#" class="h1 mb-2 product-title pvl44"><?php echo e(Str::limit($product->name, 26)); ?></a>

            <div class="mb-3 text-dark">
                <span class="h3 font-weight-normal text-accent mr-1">
                  Strength: <?php echo e(Str::limit($product->strength, 26)); ?>
        ...
        <div class="col-12">
            ...
            <form id="add-to-cart-form" class="mb-2">
                ...
                <?php if(Auth::user()->shop_id != 79): ?>
                    <div class="select-option">
                        <div class="h3 p-0"> <?php echo e(trans('Batch Name')); ?>
                ...
                <?php else: ?>
                     ...
                     <input type="hidden" name="batch_no" value="<?php echo e(random_int(100000, 999999)); ?>">
                <?php endif; ?>
                   
                    <?php if(Auth::user()->shop_id != 79): ?>
                    <div class="select-option">
                        <div class="h3 p-0"> <?php echo e(trans('Expire Date')); ?>
                    ...
                    <div class="select-option">
                        <div class="h3 p-0"> <?php echo e(trans('MRP Per Unit')); ?>

                        </div>
    
                        <div class="d-flex justify-content-left flex-wrap pvl49">
                            <input class="form-control" type="number" step="0.01" name="mrp" id="select" placeholder="MRP" <?php if($batch != null): ?> value="<?php echo e(number_format($batch->price, 2)); ?>" <?php endif; ?>>
                    ...
                    <div class="select-option">
                        <div class="h3 p-0"> <?php echo e(trans('Buy Price Per Unit')); ?>
                     ...
                     <div class="h3 p-0">Vendor </div>
                      <select class="select2 form-select form-control" id="select2-basic" data-select2-id="select2-basic" tabindex="-1" aria-hidden="true" name="vendor_id">
                          ...
                          <?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($vendor->id); ?>" <?php if($product->vendor_id == $vendor->id): ?> selected <?php endif; ?>><?php echo e($vendor->name); ?> </option>
            ...
            <!-- Quantity + Add to cart -->
                <div class="d-flex justify-content-end mt-5">
                    <div class="product-description-label mt-2 text-dark h3"><?php echo e(__('Quantity')); ?>:</div>
                ...
                <div class="d-flex justify-content-center mt-2">
                    <button class="btn btn-primary pvl45"
                        ...
                        <?php echo e(trans('pages.add_to_cart')); ?>
...
<?php /**PATH C:\xampp\htdocs\pharmacyapp\resources\views/sell/_quick-view-data.blade.php ENDPATH**/ ?>