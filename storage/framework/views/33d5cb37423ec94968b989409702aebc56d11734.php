...
<?php $__env->startSection('custom-js'); ?>
 ...
 <!-- BEGIN: Page Vendor JS-->
    ...
    var table = $('.user-list-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "<?php echo e(route('upcoming')); ?>",
        columns: [
            {data: 'id', name: 'id'},
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pharmacyapp\resources\views/medicine/upcoming.blade.php ENDPATH**/ ?>