...
<?php $__env->startSection('title', __('pages.vendor_list')); ?>
...
<section class="app-user-list">
    ...
    <div class="card-body border-bottom">
        <h4 class="card-title"><?php echo e(translate('Vendor List')); ?></h4>
        <div class="row">
            ...
            <table class="user-list-table table table-bordered border-dark">
                <thead class="table-light">
                    <tr>
                        ...
                        <th>due <?php echo e(Auth::user()->shop->currency); ?></th>
                        <th>payable <?php echo e(Auth::user()->shop->currency); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pharmacyapp\resources\views/vendor/list.blade.php ENDPATH**/ ?>