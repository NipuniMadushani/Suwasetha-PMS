...
<section class="app-user-view-account">
    <div class="row">
                ...
                <div class="card-body">
                    <div class="user-avatar-section">
                        <div class="d-flex align-items-center flex-column">
                            ...
                            <div class="user-info text-center">
                                ...
                                <span class="badge bg-light-secondary"><?php echo e(__('pages.supplier')); ?></span>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex justify-content-around my-2 pt-75">
                        ...
                        <div class="d-flex align-items-start">
                            ...
                            <div class="ms-75">
                                <h4 class="mb-0"><?php echo e($due); ?> <?php echo e(Auth::user()->shop->currency); ?></h4>
                    ...
                    <div class="info-container">
                        <ul class="list-unstyled">
                            ...
                            <li class="mb-75">
                                <span class="fw-bolder me-25"><?php echo e(__('pages.total_purchase')); ?>:</span>
                                <span><?php echo e($invoice->count()); ?></span>
                            </li>
                            <li class="mb-75">
                                <span class="fw-bolder me-25"><?php echo e(__('pages.total_tranasction')); ?>:</span>
        ...
        <!-- User Content -->
            ...
            <div class="card">
                <div class="card-body border-bottom">
                    <h4 class="card-header"><?php echo e(__('pages.purchase_history')); ?></h4>
                    <div class="row">
                        <form method="get">
        ...
        <div class="col-xl-12 col-lg-7 col-md-7 order-0 order-md-1">
            ...
            <div class="card">
                <div class="card-body border-bottom">
                    <h4 class="card-header"><?php echo e(__('pages.medicines')); ?></h4>
                </div>
                <div class="table-responsive">
 ...
 <!-- BEGIN: Page Vendor JS-->
   ...
   <script src="<?php echo e(asset('dashboard/app-assets/js/scripts/pages/app-invoice.min.js')); ?>"></script>
    ...
    var table = $('.datatable-project').DataTable({
        ...
        ajax: {
          url: "<?php echo e(route('supplier.view', $customer->id)); ?>",
          data: function (d) {
                d.from = <?php echo e(request()->get('from')); ?>,
                d.to = <?php echo e(request()->get('to')); ?>,
                d.purchases = "<?php echo e(__('pages.supplier')); ?>",
            }
        },
        <?php else: ?>
       ajax: {
...
$(function () {
    ...
    processing: true,
    serverSide: true,
        ajax: "<?php echo e(route('supplier.view', $customer->id)); ?>",      
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pharmacyapp\resources\views/supplier/view.blade.php ENDPATH**/ ?>